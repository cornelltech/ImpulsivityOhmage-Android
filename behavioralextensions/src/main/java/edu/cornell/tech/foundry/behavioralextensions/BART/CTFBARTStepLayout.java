...
import edu.cornell.tech.foundry.behavioralextensions.BXHelpers;
import edu.cornell.tech.foundry.behavioralextensions.R;
...
public class CTFBARTStepLayout extends FrameLayout implements StepLayout {
    ...
    private void pumpButtonHandler(int pumpCount, CTFBARTTrial trial, DoTrialCompletion completion) {
        ...
        boolean popped = BXHelpers.coinFlip(true, false, popProb);
